...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 122: (a, b, c) => {
      "use strict";
      let d;
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let aw = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: ax, propagation: ay, trace: az, SpanStatusCode: aA, SpanKind: aB, ROOT_CONTEXT: aC } = d = c(299);
      ...
      c(327), "undefined" == typeof URLPattern || URLPattern;
      var bh = c(624);
      ...
      function bt(a10) {
        ...
        if (b2.startsWith("/dashboard/login")) return S.next();
        if (a10.cookies.get("personal-os-authenticated")?.value !== "true") {
          let b3 = a10.nextUrl.clone();
          return b3.pathname = "/dashboard/login", S.redirect(b3);
        }
        return S.next();
      }
      ...
      let e = c(282), f = { url: (a2) => a2.url, header: (a2, b2) => a2.headers.get(b2) };
